...
namespace OranUnityUtils
{
	public static class TransformExtensionMethods {
		...
		public static void ResetPosRotAndScale(this Transform transf){
			transf.ResetPosAndRot ();
		...
		public static Transform FindChildContaining(this Transform transform, string s){
			foreach (Transform t in transform) {
